...
const SOCIALS = [
  { icon: <GitHubIcon />,   href: 'https://github.com/Yogesh-Bhatt-SWD',           label: 'GitHub' },
  { icon: <LinkedInIcon />, href: 'https://www.linkedin.com/in/yogesh-bhatt-swd/', label: 'LinkedIn' },
  { icon: <LeetCodeIcon />, href: 'https://leetcode.com/u/Y_ogesh_SwD/',           label: 'LeetCode' },
];
        ...
        <div className="hero-grid">
          ...
          <div className="hero-left">
            ...
            <div className="hero-actions">
              ...
              <a
                href="https://github.com/Yogesh-Bhatt-SWD"
                target="_blank"
                rel="noreferrer"
